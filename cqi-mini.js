...
function exportMiniCqiSection(key){
 ...
 const rows=[['CQI '+names[key],r.range.from,r.range.to,'ปีที่เลือก',r.years.map(y=>y+543).join('; ')],['ตัวตั้ง','ตัวหาร','ร้อยละ','เป้าหมาย','สูตร'],[num,den,miniCqiPct(num,den),{kpi1:'100%',kpi2:'ทุกเดือน <20%',kpi3:'≥95%'}[key],formulas[key]]];
